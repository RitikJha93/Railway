...
st.executeUpdate("insert into PNR_STATUS(PNR_NO,NAME,AGE,GENDER,BERTH)values('"+Pnr+"','"+passenger1+"','"+age1+"','"+gender1+"','"+berth1+"')");
}
if(!passenger2.equals("")){
st.executeUpdate("insert into PNR_STATUS(PNR_NO,NAME,AGE,GENDER,BERTH)values('"+Pnr+"','"+passenger2+"','"+age2+"','"+gender2+"','"+berth2+"')");
}
if(!passenger3.equals("")){
st.executeUpdate("insert into PNR_STATUS(PNR_NO,NAME,AGE,GENDER,BERTH)values('"+Pnr+"','"+passenger3+"','"+age3+"','"+gender3+"','"+berth3+"')");
}
if(!passenger4.equals("")){
st.executeUpdate("insert into PNR_STATUS(PNR_NO,NAME,AGE,GENDER,BERTH)values('"+Pnr+"','"+passenger4+"','"+age4+"','"+gender4+"','"+berth4+"')");
}
if(!passenger5.equals("")){
st.executeUpdate("insert into PNR_STATUS(PNR_NO,NAME,AGE,GENDER,BERTH)values('"+Pnr+"','"+passenger5+"','"+age5+"','"+gender5+"','"+berth5+"')");
}
if(!passenger6.equals("")){
st.executeUpdate("insert into PNR_STATUS(PNR_NO,NAME,AGE,GENDER,BERTH)values('"+Pnr+"','"+passenger6+"','"+age6+"','"+gender6+"','"+berth6+"')");
}
